...
A demonstrative API application built with Symfony 5 for PHP 7.4^, using only symfony core packages, with every request and response standardized to json strings. 
